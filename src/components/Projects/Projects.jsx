...
const projects = [
  {
    ...
    title: 'SD CREATIONS',
    description:
      'Tienda web Full Stack desarrollada para un negocio real de productos personalizados, con catálogo dinámico, panel administrativo privado, autenticación JWT, gestión de productos y variantes, carga de imágenes con Cloudinary, carrito de compras y generación de pedidos por WhatsApp.',
    previewType: 'live',
    preview: 'https://sdcreations.mqgiadev.com',
    previewMode: 'desktop',
  ...
  },
  {
    ...
    description:
      'Aplicación Full Stack con registro e inicio de sesión propios, autenticación segura con JWT y bcrypt, rutas protegidas, autorización por usuario, gestión de perfiles, tarjetas y likes, API REST y base de datos MongoDB desplegada en producción.',
    previewType: 'live',
    preview: 'https://around-us-client.vercel.app',
    previewMode: 'desktop',
    liveUrl: 'https://around-us-client.vercel.app',
